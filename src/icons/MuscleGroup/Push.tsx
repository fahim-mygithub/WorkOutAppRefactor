 ...
 *
 * Source: game-icons.net "weight-lifting-up" by Delapouite (CC BY 3.0)
 * https://game-icons.net/1x1/delapouite/weight-lifting-up.html
 *
 * Note: an overhead-press silhouette is used here because game-icons.net does
 * not currently publish a `bench-press` glyph. Overhead pressing is the
 * canonical push movement; biceps (a previous candidate) actually fire on
 * pull patterns, so they were rejected.
 */
