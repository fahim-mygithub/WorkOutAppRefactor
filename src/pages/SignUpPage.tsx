    ...
    <div className="min-h-full bg-surface flex items-center justify-center p-4">
      <Card elevation={2} className="max-w-md w-full p-8">
        <div className="text-center mb-8">
          <h1 className="text-display-lg font-bold text-ink mb-2">Create Account</h1>
          <p className="text-ink-subtle">Join us and start tracking your workouts</p>
        </div>
        ...
        {password !== confirmPassword && confirmPassword && (
          <div className="mb-4 rounded-md border border-danger bg-danger/10 p-3">
            <p className="text-danger text-body-sm">Passwords do not match</p>
          </div>
        )}
